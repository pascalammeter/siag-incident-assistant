...
- [x] 02-03-PLAN.md — `StepNavigator` + `WizardProgress` + `WizardShell` (Navigation-UI)
- [x] 02-04-PLAN.md — `react-hook-form` + Zod Integration (StepForm, Schemas, Tests)
- [x] 02-05-PLAN.md — 7 Placeholder-Screens scaffolden + Wizard auf Hauptseite mounten
...
- [x] 04-02-PLAN.md — Screen 4 Reaktionsschritte: Checklisten-UI, Phase-Gruppen, No-Go-Amber-Boxes, Rollen-Badges, Fortschrittszaehler
- [x] 04-03-PLAN.md — Screen 5 Meldepflicht: 3-Ja/Nein-Fragen, Fristen-Anzeige (ISG/DSG/FINMA), Kommunikations-Checkliste, SIAG-CTA
- [x] 04-04-PLAN.md — Screen 5 Kommunikationsbausteine: Textvorlagen fuer GL, Mitarbeitende, Medien (editierbar, kopierbar)
...
Plans:
- [x] 05-01-PLAN.md — Screen 6 Incident-Zusammenfassung: alle State-Felder konsolidiert, 6 Summary-Karten, SIAG-CTA, Nächste Schritte
- [x] 05-02-PLAN.md — Screen 6 Print-Export: window.print(), @media print CSS, Bericht exportieren Button
...
Plans:
- [x] 06-01-PLAN.md — Production Build verifizieren: turbopack.root fix, `npm run build` clean, 74 tests green
- [x] 06-02-PLAN.md — Vercel Production Deploy: git push main → GitHub integration → live URL (human checkpoint)
- [x] 06-03-PLAN.md — End-to-End Smoke Test: 7-Screen-Durchlauf, localStorage-Reload, Print-Export (manual checklist)
